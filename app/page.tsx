        ...
        <div className="mx-auto max-w-105">
          <div className="mb-8 flex flex-col gap-4">
            ...
            <p className="text-muted-foreground">
              ...
              diving into design challenges. Lately, I've been having fun mixing
              design with code and AI.
              <br />
              <br />I work best when teaming up to solve real problems. My
              secret sauce? Quick sketches, prototypes, and lots of tweaking
              until we nail it. Keep it fun, get it done.
            </p>
          </div>
